 ...
 * LinkedIn) is fetched from the API. The experience and skills content is
 * kept inline for simplicity.
 *
 * To make this fully data-driven later, add Experience and Education models
 * to the Prisma schema in apps/api and follow the same pattern as Project.
 */
  ...
  return (
    ...
    >
      ...
      <Section title="Technical Skills">
        ...
        <SkillRow label="Backend & APIs" value="FastAPI, ASP.NET Core, Node.js, NestJS, REST API, WebSocket" />
