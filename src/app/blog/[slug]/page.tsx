 ...
 *
 * Fetches a single published post by its URL slug and renders the
 * Markdown `content` field as HTML using the `marked` library.
 *
 ...
 * (or a server-side equivalent) — see "what to learn next" in README.md.
 */
...
import { postRepository } from "@/infrastructure/container";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const post = await getPostBySlug(postRepository, slug);
